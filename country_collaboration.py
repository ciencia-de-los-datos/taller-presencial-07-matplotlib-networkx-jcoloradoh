...
# Del ejercicio anterior, se extrajo de un mismo registro los paises
# Que paises publican juntos (Se debe validar cual es la colaboración entre paises)
# Countries (a, b, c) ----> a-->b, a-->c, b-->c =====> Esta es la esencia del ejercicio (No se da a la inversa b-->a)
